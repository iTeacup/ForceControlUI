...
class UISerialCon : public UIBaseWindow
{
public:
    UISerialCon(UIMainWindowBase *main_win, const char *title);
    ~UISerialCon();
...
protected:
    SerialLogReader m_serial_reader; // Serial log reader for reading serial data
